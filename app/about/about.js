(function() {
    ...
    function About() {
        ...
        vm.team = [
            ...
            {name: 'Stanimir Kukudov', title: 'CTO / Chief Technical Officer', picture: 'stanimir.png', description: 'Description', contacts: {facebook: 'https://www.facebook.com/stanimir.kukudov', linkedin: 'https://bg.linkedin.com/in/stkukudov', twitter: '', email: 'st.kukudov@softologic.com'}},
