(function() {
    ...
    function About() {
        ...
        vm.team = [
            {name: 'Mihail Mihaylov', title: 'CEO / Chief Executive Officer', picture: 'mihail.png', description: 'Description', contacts: {facebook: '', linkedin: 'https://www.linkedin.com/in/mmihaylov', twitter: '', google: '', email: 'm.mihaylov@softologic.com'}},
            {name: 'Stanimir Kukudov', title: 'Lead Developer', picture: 'stanimir.png', description: 'Description', contacts: {facebook: '', linkedin: 'https://bg.linkedin.com/in/stkukudov', twitter: '', google: '', email: 'st.kukudov@softologic.com'}},
