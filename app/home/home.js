(function() {
    ...
    function Home($sce, $routeParams, $rootScope) {
        ...
        vm.ourServices = [
            ...
            { id: 4, title: 'One Page Applications', description: 'Single-Page Applications (SPAs) are Web apps that load a single HTML page and dynamically update that page as the user interacts with the app.', image: './images/home/icon-4-red.png', altText: '', url: $sce.trustAsResourceUrl("/services")}
        ];
